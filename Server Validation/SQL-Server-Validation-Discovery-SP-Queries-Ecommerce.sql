...
FROM [USCHWSQL1316\MAPS].[DISCOVERY].[dbo].[v_ps_DB_Properties_All] v_ps_DB_P_A
...
FROM [USCHWSQL1316\MAPS].[DISCOVERY].[dbo].[v_WinViewALL] v_WVA
...
FROM [USCHWSQL1316\MAPS].[DISCOVERY].[dbo].[v_WinViewDisk] v_WVD
...
FROM [USCHWSQL1316\MAPS].[DISCOVERY].[dbo].[v_InstanceProperties_All] v_IP_A
...
FROM [USCHWSQL1316\MAPS].[DISCOVERY].[dbo].[sccm_v_GS_Service] sccm_v_GS_S
